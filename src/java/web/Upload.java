...
import methods.paretoMethods;
import methods.paretoMethods.polComparator;
import methods.paretoMethods.polComparator2;
...
public class Upload extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (method.equals("greenw")) {
            System.out.print("greenwood");

        }
        if (method.equals("fonflem")) {
            System.out.print("fonflem");
        }
        if (method.equals("spea")) {
            System.out.print("spea");
